import logo from '../images/optysys-logo-white.svg'
...
const navigation = {
    ...
    social: [
        ...
        {
            name: 'GitHub',
            href: 'https://github.com/newmatik/optysys',
            icon: (props: any) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
        ...
        {
            name: 'Linkedin',
            href: 'https://www.linkedin.com/company/newmatik/',
            icon: (props: any) => (
    ...
    return (
        <footer className="bg-gray-950" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-8 sm:pt-24 lg:px-8 lg:pt-8">
                ...
                <div className="mt-8 border-t border-white/10 pt-8 sm:mt-20 lg:mt-8">
                    <p className="text-xs leading-5 text-gray-400">&copy; 2023 <a href="https://github.com/newmatik">Newmatik GmbH, Am Markt 1, 55619 Hennweiler, Germany</a>. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
